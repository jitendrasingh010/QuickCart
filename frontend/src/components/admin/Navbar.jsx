...
function Navbar({ onToggleSidebar = () => { } }) {
  ...
  const getPageTitle = () => {
    ...
    if (pathname.startsWith("/admin/customers")) return "Customer Telemetry";
    if (pathname.startsWith("/admin/profile")) return "Admin Settings & Profile";
    ...
    if (typeof window !== "undefined") {
      ...
      if (stored) {
        try {
          ...
          console.error("Error reading cached admin user", e);
        }
      }
    }
  ...
  const adminName = adminUser?.firstName
    ...
    : "Administrator";
  const adminEmail = adminUser?.email || "admin@quickcart.com";
  const adminInitial = adminName.charAt(0).toUpperCase() || "A";
  const profileImage = adminUser?.profileImage || adminUser?.image;
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              <div className="hidden sm:block text-left">
                ...
                <p className="text-[11px] text-slate-500 dark:text-slate-400 font-medium leading-tight max-w-[140px] truncate mt-0.5">
                  {adminEmail}
                </p>
              </div>
                ...
                >
                  <div className="p-3.5 bg-gradient-to-br from-slate-50 to-blue-50/50 dark:from-slate-800/60 dark:to-slate-800/30 rounded-2xl border border-slate-100 dark:border-slate-700/60 flex items-center gap-3.5 mb-2">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-1.5">
                        ...
                        <ShieldCheck size={14} className="text-blue-600 dark:text-blue-400 flex-shrink-0" />
                      </div>
                  ...
                  <div className="space-y-1">
                    <Link
                      ...
                      className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs sm:text-sm font-semibold text-slate-700 dark:text-slate-200 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50/80 dark:hover:bg-slate-800 transition-all duration-150 group"
                    >
                      ...
                      <div className="text-left">
                        <span className="block leading-tight">My Profile</span>
                    ...
                    <Link
                      href="/admin/profile"
                      onClick={() => setIsDropdownOpen(false)}
                      className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs sm:text-sm font-semibold text-slate-700 dark:text-slate-200 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50/80 dark:hover:bg-slate-800 transition-all duration-150 group"
                    >
                      ...
                      <div className="text-left">
                        <span className="block leading-tight">Edit Profile</span>
                        <span className="text-[10px] text-slate-400 font-normal">
                    ...
                    <Link
                      href="/admin/profile"
                      onClick={() => setIsDropdownOpen(false)}
                      className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs sm:text-sm font-semibold text-slate-700 dark:text-slate-200 hover:text-violet-600 dark:hover:text-violet-400 hover:bg-violet-50/80 dark:hover:bg-slate-800 transition-all duration-150 group"
                    >
                      ...
                      <div className="text-left">
                        <span className="block leading-tight">Change Password</span>
                        <span className="text-[10px] text-slate-400 font-normal">
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs sm:text-sm font-semibold text-rose-600 dark:text-rose-400 hover:bg-rose-50/90 dark:hover:bg-rose-950/40 transition-all duration-150 cursor-pointer group"
                    >
                      ...
                      <div className="text-left">
                        <span className="block leading-tight font-bold">Logout</span>
